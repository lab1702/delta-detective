...
def main(argv=None):
    ...
    init.add_argument("reference", help="Reference CSV/Parquet file or snapshot directory.")
    init.add_argument("current", help="Current CSV/Parquet file or snapshot directory.")
